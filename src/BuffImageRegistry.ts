...
export class BuffImageRegistry {
  ...
  private static _buffData: Array<{ name: string; image: any; threshold: number; path: string, hasAbilityCooldown: boolean, abilityCooldown: number, isTarget: boolean, debug: boolean }> = [];
}
