...
var BuffManager = /** @class */ (function () {
    function BuffManager(storage) {
        ...
        this.OVERLAY_POSITION_KEY = 'overlayPosition';
        ...
        this.getActiveBuffs = function () { return __awaiter(_this, void 0, void 0, function () {
            var activeBuffs, activeDebuffs, buffsAndDebuffs, currentActiveBuffs_1, registeredBuffs, _i, buffsAndDebuffs_1, activeBuff, _a, registeredBuffs_1, buffData, matchResult, cooldown, existingBuff, newCooldown, newProgress, newInitialCooldown, buffsArray;
            var _this = this;
            var _b, _c;
                        ...
                        for (_i = 0, buffsAndDebuffs_1 = buffsAndDebuffs; _i < buffsAndDebuffs_1.length; _i++) {
                            ...
                            for (_a = 0, registeredBuffs_1 = registeredBuffs; _a < registeredBuffs_1.length; _a++) {
                                ...
                                if (matchResult.passed >= buffData.threshold) {
                                    cooldown = ((_b = activeBuff.readArg('timearg')) === null || _b === void 0 ? void 0 : _b.time) || 0;
                                    ...
                                    if (cooldown <= 59) {
                                        ...
                                        newInitialCooldown = (existingBuff === null || existingBuff === void 0 ? void 0 : existingBuff.initialCooldown) || cooldown;
        ...
        this.setOverlayPosition = function () {
            ...
            alt1__WEBPACK_IMPORTED_MODULE_0__.once('alt1pressed', function () {
                try {
                    ...
                    _this.storage.save(_this.OVERLAY_POSITION_KEY, {
        ...
        this.captureOverlay = function (element) { return __awaiter(_this, void 0, void 0, function () {
            var filter, dataUrl, overlayPosition, base64ImageString, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        dataUrl = _a.sent();
                        overlayPosition = this.storage.get(this.OVERLAY_POSITION_KEY);
                        if (!overlayPosition)
                            return [2 /*return*/];
...
/* harmony import */ var _audio_pop_alert_mp3__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./audio/pop-alert.mp3 */ "./audio/pop-alert.mp3");
...
/* harmony import */ var _BuffManager__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./BuffManager */ "./BuffManager.ts");
...
/* harmony import */ var _LocalStorageHelper__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./LocalStorageHelper */ "./LocalStorageHelper.ts");
...
var storage = new _LocalStorageHelper__WEBPACK_IMPORTED_MODULE_8__.LocalStorageHelper();
var buffManager = new _BuffManager__WEBPACK_IMPORTED_MODULE_5__.BuffManager(storage);
// Initialize Alt1 app
if (window.alt1) {
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('buffsData', function () { return ({
    ...
    audio: new Audio(_audio_pop_alert_mp3__WEBPACK_IMPORTED_MODULE_3__),
    ...
    checkAndPlayAlerts: function () {
        ...
        this.buffs.forEach(function (buff) {
            ...
            if (isFlashing && buff.isAudioQueued && !_this.alertedBuffs.has(buff.name)) {
                // Play alert sound
            ...
            else if (!isFlashing && _this.alertedBuffs.has(buff.name)) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                updateLoop = function () { return __awaiter(_this, void 0, void 0, function () {
                    var existingBuffs, buffContainer, innerHtml, readyToCapture;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!!this.isDragging) return [3 /*break*/, 5];
                            ...
                            case 2:
                                // Wait for Alpine to update the DOM
                                _a.sent();
                                buffContainer = document.getElementById("buffs-output");
                                innerHtml = stripAlpine(buffContainer.outerHTML);
                            ...
                            case 3:
                                _a.sent();
                                return [4 /*yield*/, buffManager.captureOverlay(readyToCapture)];
                            case 4:
                                _a.sent();
...
function start() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, _BuffImageRegistry__WEBPACK_IMPORTED_MODULE_4__.BuffImageRegistry.initialize()];
                case 1:
                    _a.sent();
