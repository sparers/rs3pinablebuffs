...
var BuffManager = /** @class */ (function () {
    function BuffManager(storage) {
        ...
        this.getActiveBuffs = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                if (this.buffs.pos || this.debuffs.pos) {
                    ...
                    activeBuffs = this.buffs.pos ? this.buffs.read() || [] : [];
                    activeDebuffs = this.debuffs.pos ? this.debuffs.read() || [] : [];
                    buffsAndDebuffs = __spreadArray(__spreadArray([], activeBuffs, true), activeDebuffs, true);
                    if (buffsAndDebuffs.length > 0) {
                        currentActiveBuffs_1 = new Set();
                        registeredBuffs = _BuffImageRegistry__WEBPACK_IMPORTED_MODULE_3__.BuffImageRegistry.buffData;
                        for (_i = 0, buffsAndDebuffs_1 = buffsAndDebuffs; _i < buffsAndDebuffs_1.length; _i++) {
                            activeBuff = buffsAndDebuffs_1[_i];
                            for (_a = 0, registeredBuffs_1 = registeredBuffs; _a < registeredBuffs_1.length; _a++) {
                                buffData = registeredBuffs_1[_a];
                                if (buffData.image == null)
                                    continue;
                                matchResult = activeBuff.countMatch(buffData.image, false);
                                if (buffData.debug) {
                                    console.log("debug: ".concat(buffData.name, ":").concat(buffData.threshold, " -> passed: ").concat(matchResult.passed));
                                }
                                if (matchResult.passed >= buffData.threshold) {
                                    buffCooldown = ((_b = activeBuff.readArg('timearg')) === null || _b === void 0 ? void 0 : _b.time) || 0;
                                    currentActiveBuffs_1.add(buffData.name);
                                    existingBuff = this.matchedBuffsCache.get(buffData.name);
                                    newBuffCooldown = void 0;
                                    newProgress = void 0;
                                    newInitialCooldown = void 0;
                                    if (buffCooldown <= 59) {
                                        // For short buffs, always use game's cooldown
                                        newBuffCooldown = buffCooldown;
                                        newInitialCooldown = (existingBuff === null || existingBuff === void 0 ? void 0 : existingBuff.initialBuffCooldown) || buffCooldown;
                    ...
                    buffsArray = Array.from(this.matchedBuffsCache.values());
        ...
        this.captureOverlay = function (group, element, scale) { return __awaiter(_this, void 0, void 0, function () {
            var filter, style, dataUrl, overlayPosition, base64ImageString, e_1;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        filter = function (node) {
                            var _a;
                            return !((_a = node.classList) === null || _a === void 0 ? void 0 : _a.contains('exclude-me'));
                        };
...
"use strict";
module.exports = __webpack_require__.p + "pop-alert.mp3";
...
/* harmony import */ var _audio_long_pop_alert_wav__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./audio/long-pop-alert.wav */ "./audio/long-pop-alert.wav");
/* harmony import */ var _audio_pop_alert_mp3__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./audio/pop-alert.mp3 */ "./audio/pop-alert.mp3");
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('buffsData', function () { return ({
    ...
    lowCooldownAlertedBuffs: new Set(),
    audio: new Audio(_audio_pop_alert_mp3__WEBPACK_IMPORTED_MODULE_4__),
    longAudio: new Audio(_audio_long_pop_alert_wav__WEBPACK_IMPORTED_MODULE_3__),
    activeTab: 'buffs',
    timestamp: null,
    lastUpdate: Date.now(),
    overlaySettings: {
    ...
    loadOverlaySettings: function () {
        ...
        if (saved) {
            this.overlaySettings = {
                ...
                buffCooldownThreshold: (_b = saved.buffCooldownThreshold) !== null && _b !== void 0 ? _b : 30,
                abilityCooldownThreshold: (_c = saved.abilityCooldownThreshold) !== null && _c !== void 0 ? _c : 5
            };
        }
        else {
            this.overlaySettings = {
    ...
    isLowBuffCooldown: function (buff) {
        var isLowBuffCooldown = buff.progress <= this.overlaySettings.buffCooldownThreshold && buff.buffCooldown > 0 && buff.buffCooldown <= 60;
        return isLowBuffCooldown;
    },
    isLowCooldown: function (buff) {
        var isLowCooldown = buff.cooldown <= this.overlaySettings.abilityCooldownThreshold && buff.cooldown > 0;
        return isLowCooldown;
    },
    checkAndPlayAlerts: function () {
        var _this = this;
        this.buffs.forEach(function (buff) {
            var isLowBuffCooldown = _this.isLowBuffCooldown(buff);
            if (isLowBuffCooldown && buff.isPinned && !_this.alertedBuffs.has(buff.name)) {
                // Play alert sound
                if (buff.isAudioQueued) {
                    _this.audio.currentTime = 0;
                    _this.audio.play().catch(function (err) { return console.log('Audio play failed:', err); });
                }
                // Mark this buff as alerted
                _this.alertedBuffs.add(buff.name);
            }
            else if (!isLowBuffCooldown && _this.alertedBuffs.has(buff.name)) {
                // Remove from alerted set when buff is no longer flashing
                _this.alertedBuffs.delete(buff.name);
            }
            var isLowCooldown = _this.isLowCooldown(buff);
            if (isLowCooldown && buff.isPinned && !_this.lowCooldownAlertedBuffs.has(buff.name)) {
                // Play long alert sound
                if (buff.isAudioQueued) {
                    _this.longAudio.currentTime = 0;
                    _this.longAudio.play().catch(function (err) { return console.log('Long audio play failed:', err); });
                }
                // Mark this buff as alerted
                _this.lowCooldownAlertedBuffs.add(buff.name);
            }
            else if (!isLowCooldown && _this.lowCooldownAlertedBuffs.has(buff.name)) {
                _this.lowCooldownAlertedBuffs.delete(buff.name);
            }
        });
    },
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                updateLoop = function () { return __awaiter(_this, void 0, void 0, function () {
                    var existingBuffs, scale;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!(!this.isDragging && !this.resetInprogress)) return [3 /*break*/, 5];
                                return [4 /*yield*/, buffManager.getActiveBuffs()];
                            case 1:
                                existingBuffs = _a.sent();
                                if (existingBuffs) {
                                    this.buffs = existingBuffs.map(function (b) { return (__assign({}, b)); });
                            ...
                            case 3:
                                _a.sent();
                                return [4 /*yield*/, captureElementAsOverlay("alerted-buffs", CENTER_OVERLAY_GROUP, scale)];
                            case 4:
                                _a.sent();
                                _a.label = 5;
                            case 5:
